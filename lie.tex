...
Allgemeiner? Über $\C$?
\end{comment}
\begin{defn} \ccite[3.6 Definition]{warnerLie}
\begin{itemize}
\item 
...
\]
\comm{oder äquivalent $l_\sigma'(X(\tau))=X(\sigma\tau)$ für alle $\tau$} gilt.
\end{itemize}
\end{defn}
\begin{defn} \ccite[3.8 Definition]{warnerLie}
...
\end{defn}
\begin{exmp}\ccite[Example 3.10 (d)]{warnerLie}
...
\comm{(weiter wie in \protect\ccite[Example 3.10 (b)]{warnerLie})}
\end{exmp}
...
\]
\end{bem}
\begin{defn}[Koadjungierte Orbiten] \ccite[P. 86]{bryant}
