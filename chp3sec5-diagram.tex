...
all the defined isomorphisms and rewrite it into the following commutative
...
\begin{center}
  \begin{tikzpicture}[scale=0.95,transform shape]
    ...
    \ifnum\myDevelopVariable=1
        \draw[->,red] (S2P) to[in=39,out=180] node[midway,above] {$\tau$} (cH3);
        \draw[->,red] (cH3) to[out=52,in=195] node[midway,above,sloped] {(quotient map)} (StA0);
    \fi
  \end{tikzpicture}
\end{center}
Where
