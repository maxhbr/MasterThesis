...
\begin{figure}[h!] %{{{
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \draw[->,purple!50!white,thick] (n2) to[out=270,in=70] (f1);
...
\begin{prop}\label{prop:representation}
  ...
  is an isomorphism which maps a germ of $\Sto_\theta(A^0)$ to the corresponding
...
\begin{proof}
  ...
  matrix with zeros at the necessary positions characterizes a unique
