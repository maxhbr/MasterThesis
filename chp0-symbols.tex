...
\begin{longtable}[h]{>{\raggedright}p{4cm}@{\hspace{.2cm}}p{10cm}}
  ...
  $\cH(\cM^{nf},\nabla^{nf})$ \dotfill~& the space of isomorphism classes of
                                         marked (meromorphic) pairs\\
...
\begin{longtable}[h]{>{\raggedright}p{4cm}@{\hspace{.2cm}}p{10cm}}
  ...
  $\St(A^0)$ \dotfill~& $H^1(S^1;\Lambda(A^0))$; the first non abelian cohomology of the
    Stokes sheaf\\
  ...
  $\vartheta_\alpha$ \dotfill~& The map from Definition~\ref{defn:groupOfFaithfullReps}\\
  ...
  $\SSto_\theta(A^0)$ \dotfill~& the group of all Stokes matrices of $A^0$ in direction
    $\theta$\\
  $\hat\SSto_\theta(A^0)$ \dotfill~& The space of collected Stokes matrices\\
  $\hat\vartheta_\alpha$ \dotfill~& The map from Remark~\ref{rem:groupOfFaithfullReps}\\
