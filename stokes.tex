...
\begin{cor}\label{cor:composeLevelwise}
  Let $T_1,\dots,T_r$ be a subsets of the position set $T$, such that
  \begin{itemize}
...
all the defined isomorphisms can be written into one big diagram.
\begin{center}
  \begin{tikzpicture}
    ...
    \draw[->] (ProdOfSStos) -- (SSS3P)
      node[midway,below left] {Cor.\ref{cor:isomToChochN}};
  \end{tikzpicture}
\end{center}
Where
\begin{itemize}
