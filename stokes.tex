...
\begin{center}
  \begin{tikzpicture}[scale=3]
    ...
    \node[purple] (class) at (1,0) {$\G\backslash\tilde\G(B_0)$};
...
\begin{defn}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=3]
      ...
      \node[right] at ({cos( 355 )},{sin( 355 )}) {$d_r$};
    ...
    \item \textbf{The product of the corresponding groups of Stokes factors}
      ...
      \begin{itemize}
        \item $\myP\in G$ the permutation Matrix associated to $\textbf{d}$
          ...
          \begin{itemize}
            \item
              \marginnote{The ordering on $\textbf{d}+l$ is opposite to this
                ordering}
