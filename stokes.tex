...
\begin{prop}\label{prop:result2}
  ...
  \[
    \C^{k_1+2\cdot k_2}
    \textcolor{green!50!black}{\longrightarrow}
    \St(A^0)
  \]
...
\[ \begin{tikzcd}
  ...
  \\
    ...
    &\prod_{k\in\{k_1,k_2\}}\prod_{\theta\in\A}\SSto_{\theta}^{k}(A^0)
     ...
     \arrow[dr,green!50!black]
  \\\prod_{\theta\in\A} \Sto_{\theta}(A^0)
    \arrow[rr,purple,"\prod_{\theta\in\A}i_\theta"]
    &&\prod_{k\in\{k_1,k_2\}}\prod_{\theta\in\A}\Sto_{\theta}^{k}(A^0)
    \dar[xshift=-1pt,purple]
    \dar[xshift=1pt,green!50!black]{\prod_{k\in\{k_1,k_2\}}i^k}
  \\
    && \prod_{k\in\cK}\Gamma(\dot\cU^k;\Lambda^k(A^0))
    \dar[xshift=-1pt,purple]
    \dar[xshift=1pt,green!50!black]{\cT}
  \\&& \St(A^0)
\end{tikzcd} \]
