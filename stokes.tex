...
\begin{center}
  \begin{tikzpicture}[scale=3]
    ...
    \node[purple] (class) at (0,0) {$\cH(A^0)$};
    \node[green!40!black] (sheaf) at (3,0.4) {$\St(\cM^{nf})$};
    \node[] (sheaf3) at (3,0) {\textcolor{purple}{$\St(A^0)$}};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Let us now look at Stokes cocycles.
...
\begin{center}
  \begin{tikzpicture}
    ...
    \node (cH2) at ([yshift=-2cm,xshift=3cm]cH) {$G(\!\{t\}\!)\backslash\hat G(A^0)$};
