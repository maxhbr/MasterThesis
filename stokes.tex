...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{How does a Stokes cycle in $\prod_{\theta\in\A}\Sto_\theta(A^0)$ look
  like?}
Let $A^0$ be a normal form with dimension $n=3$ and two levels
$\cK=\{k_1<k_2\}$, which satisfies, that there is at least one direction
$\theta_0$ which is beared by both levels.
...
\begin{prop}
  ...
  \begin{s-rem}
    ...
    \circ\bar\vartheta_\theta$ we can remove some \rewrite{steps}, in the
