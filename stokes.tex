...
\begin{rem}\label{rem:mapStoToCocy}
  ...
  $1$-cocycle\TODO[Proof], thus the induced map
  \[
...
\begin{comment}
  \begin{lem}
    To describe a cocycle, it is equivalent to give
    \begin{einr}
      \TODO{}
    \end{einr}
    or
    \begin{einr}
      $(\phi_\theta)_{\theta\in J}$.
    \end{einr}
  \end{lem}
\end{comment}
...
\begin{proof}
  \begin{enumerate}
    \item For map
      ...
      \]
      it is well known to be a group isomorphism. \TODO[why?]
      \begin{comment}
        IDEAS:
        \begin{itemize}
...
\begin{proof}
  \begin{enumerate}
    ...
    \item The proof of part 2.\ (similar to the proof of part 1.) can be found
      in Loday-Richaud's paper \cite[Proof of Lem.II.3.3]{Loday1994}.
      \TODO[PROOF!]
  \end{enumerate}
\end{proof}
