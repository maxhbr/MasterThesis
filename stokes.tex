...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Stokes structures: Matrix version}\label{sec:mainThm2}
\begin{comment}
...
\begin{rem}
  ...
  this in the single-leveled case by \rewrite{renaming our Stokes matrices as
  Stokes factors} and introducing new Stokes matrices which are build by the
  product of consecutive Stokes factors. He uses the rotational symmetry of the
  single-leveled case \rewrite{thus this approach is not} simply applicable to
  the multi-leveled case.
\end{rem}
...
\]
where $f_\theta:\cU_\theta^k\to\C$\TODO[ is \textbf{holomorphic}/meromorphic?].
...
\begin{rem}
  ...
  and outputs \rewrite{cohomologous} Stokes cocyle and thus solves this
  problem.
\end{rem}
...
\begin{comment}
  ...
  \marginnote{\cite[II.3.4]{Loday1994}}
  ...
  \marginnote{\cite[863ff]{Loday1994}}
\end{comment}
