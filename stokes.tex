...
\PROBLEM{Simplest, multileveled case}
...
\paragraph{What do the Stokes germs $\phi_\alpha$ look like?}
...
\textbf{Using the structure of $\SSto_\alpha(A^0)$:}
...
\paragraph{What do Stokes cocycles look like?}
