...
On can use the Stokes matrices to give an alternative characterization of
Stokes germs:
\begin{einr}
...
(cf.\ \ref{prop:representation}), yields then the corresponding Stokes cocycle
in $\prod_{\alpha\in\A}\Sto_{\alpha}(A^0)$ and thus an element in $\St(A^0)$.
\begin{comment}
