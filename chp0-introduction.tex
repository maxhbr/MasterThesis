...
as\dots} (cf.\ Section~\ref{sec:classifyingSet}).
...
This classification can be splitted in the coarse formal classification and the
...
restrictions hold for these matrices, we can explicitly give an isomorphism of
pointed sets, $\C^n\to H^1(S^1;\Lambda(A^0))$, for a convenient $n$
