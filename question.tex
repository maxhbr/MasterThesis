...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Apply the decomposition from
  proposition~\ref{prop:filtrationOfStokesGroup}}
...
\[
  \phi_\theta=\phi_\theta^{k_2}\underset{=\phi_\theta^{k_1}}{
...
\switchcolumn[0]\noindent
  \vspace*{45mm}
  \begin{itemize}
    \item[] Step 1 \tikzmarkc{n1}{black}
    \item[] Step 2 \tikzmarkc{n2}{black}
    \item[] Step 3 \tikzmarkc{n3}{black}
    \item[] Step 4 \tikzmarkc{n4}{black}
  \end{itemize}
\switchcolumn[1]\noindent
