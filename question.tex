...
constant and invertible. If we assume that $L$ is diagonal, we use the
commutation of diagonal matrices to write $A^0:=Q'(t^{-1})+L\frac{1}{t}$.
...
\begin{lem}\label{lem:formSolToMat}
  ...
  \[
    \cY_0:=t^Le^{Q(t^{-1})}
  \]
  is a fundamental solution of the system $[A^0]$.
  \begin{s-rem}
...
\textcolor{purple!75!black}{purple} cases $\cK_\theta=\{k_1\}$ and
