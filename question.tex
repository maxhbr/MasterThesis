...
\switchcolumn[0]\noindent
  ...
  \begin{itemize}
    ...
    \item[] Step 2.b \tikzmarkc{n2}{black}
    \item[] Step 2.c \tikzmarkc{n3}{black}
    \item[] Step 2.d \tikzmarkc{n4}{black}
  \end{itemize}
\switchcolumn[1]\noindent
  \[ \begin{tikzcd}[column sep=0,row sep=1.8cm]
      \displaystyle \prod_{\theta\in\cA}\Sto_\theta(A^0)
...
\begin{comment}
  \begin{itemize}
    \item[\cite{Loday1994} p.872] \dots cononical extansion of germs to ther
      natural arc of definition.
      
      \TODO[This is an isomorphism since we restrict to solutions?]
  \end{itemize}
\end{comment}
