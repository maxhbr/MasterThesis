...
the Stokes cocycle. Loday-Richaud gives an algorithm in section II.3.4 of her
paper~\cite{Loday1994}, which takes a cocycle over an arbitrary cyclic covering
...
Section~\cite[Sec.III.3]{babbitt1989local} or in~\cite[880f]{Loday1994}, where
...
can also define a scheme structure of $\St(A^0)$.
