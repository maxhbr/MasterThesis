...
\begin{center}
  \begin{tikzpicture}[scale=2.5]
    ...
    \node at (-1.5,1.5) {$\textcolor{purple}{\cU^k}:$};
    \node at (-1,1) {$\textcolor{purple}{\dot\cU^k}:$};

    \foreach \w in {55}
    {\foreach \sep in {0,45,90,135,180,225,270,315}
     {\draw[thick,purple] (0,0) -- +({cos( \w + \sep )},{sin( \w + \sep )});

      \pgfmathsetmacro\r{{1.1 + mod(\sep,2)/ 20}}
      ...
      \pgfmathsetmacro\r{{1.7 + mod(\sep,180)/1800 + mod(\sep,2)/ 10}}

      \draw[purple,thick] ({cos( \w + \sep -22) * \r},{sin( \w + \sep -22) * \r})
        arc ({\w + \sep - 22}:{\w + \sep + 22 + 44}:\r);
      }};

    \foreach \w in {10,20,55}
    {\foreach \sep in {0,60,120,180,240,300}
     {\draw[blue!40!white] (0,0) -- +({cos( \w + \sep )},{sin( \w + \sep )});}};

    \foreach \w in {30,35}
    {\foreach \sep in {0,90,180,270}
     {\draw[red!40!white] (0,0) -- +({cos( \w + \sep )},{sin( \w + \sep )});}};
...
\begin{center}
  \begin{tikzpicture}[scale=2.5]
    ...
    \node at (-1.5,1.5) {$\textcolor{blue}{\cU^k}:\TODO$};
    \node at (-1.2,1.2) {$\textcolor{blue}{\dot\cU^k}:$};

    \foreach \w in {55}
    {\foreach \sep in {0,45,90,135,180,225,270,315}
     {\draw[purple!40!white] (0,0) -- +({cos( \w + \sep )},{sin( \w + \sep )});}};

    \foreach \w in {10,20,55}
    {\foreach \sep in {0,60,120,180,240,300}
     {\draw[blue] (0,0) -- +({cos( \w + \sep )},{sin( \w + \sep )});

     \pgfmathsetmacro\r{{1.1 + mod(\w,20)/100 + mod(\w,2)/10 + mod(\sep,120)/1200}}
      \draw[dotted,blue] ({cos( \w + \sep )},{sin( \w + \sep )})
        -- ({cos( \w + \sep) * \r},{sin( \w + \sep) * \r});

      \draw[blue,thick] ({cos( \w + \sep -29) * \r},{sin( \w + \sep -29) * \r})
        arc ({\w + \sep - 29}:{\w + \sep + 29}:\r);}};
...
\begin{center}
  \begin{tikzpicture}[scale=2.5]
    ...
    \node at (-1.5,1.5) {$\textcolor{red}{\cU^k}:\TODO$};
    \node at (-1,1) {$\textcolor{red}{\dot\cU^k}:$};
    ...
    {\foreach \sep in {0,90,180,270}
     ...
     \pgfmathsetmacro\r{{1.1 + mod(\w,2)/10 + mod(\sep,180)/1800}}
      \draw[dotted,red] ({cos( \w + \sep )},{sin( \w + \sep )})
        -- ({cos( \w + \sep) * \r},{sin( \w + \sep) * \r});

      \draw[red,thick] ({cos( \w + \sep -44) * \r},{sin( \w + \sep -44) * \r})
        arc ({\w + \sep - 44}:{\w + \sep + 44}:\r);
    }};
...
\begin{center}
  \begin{tikzpicture}[scale=2.5]
    ...
    \node at (-1.7,1.7) {$\textcolor{blue}{\dot\cU^{4}}:$};
    \node at (-2.2,2.2) {$\textcolor{green!60!black}{\dot\cU^{3}}:$};
...
\begin{center}
  \begin{tikzpicture}[scale=2.5]
    ...
    \node at (-1,1) {$\textcolor{purple}{\dot\cU^{\leq 5}}:$};
    \node at (-1.7,1.7) {$\textcolor{blue}{\dot\cU^{\leq 4}}:$};
    \node at (-2.2,2.2) {$\textcolor{green!60!black}{\dot\cU^{\leq 3}}:$};
    ...
    {\foreach \sep in {0,36,72,108,144,180,216,252,288,324}
     {\draw[thick,purple] (0,0) -- +({cos( \w + \sep )},{sin( \w + \sep )});
      ...
      \draw[purple,dashed] ({cos( \w + \sep -17.5) * \r},{sin( \w + \sep -17.5) * \r})
        -- ({cos( \w + \sep -17.5) * 2.3},{sin( \w + \sep -17.5) * 2.3});
      \draw[purple,dashed] ({cos( \w + \sep +17.5) * \r},{sin( \w + \sep +17.5) * \r})
        -- ({cos( \w + \sep +17.5) * 2.3},{sin( \w + \sep +17.5) * 2.3});
      }};
    ...
    {\pgfmathsetmacro\rr{1.7}
     ...
     {\pgfmathsetmacro\rr{{1.7 + (mod(\w,60) - 5*mod(\w,10))/150 
      ...
      \draw[dotted,blue] ({cos( \w + \sep )},{sin( \w + \sep )})
        -- ({cos( \w + \sep) * \rr},{sin( \w + \sep) * \rr});
      \draw[gray] ({cos(\sep+\w -29) * \rr},{sin(\sep+\w -29) * \rr})
        arc ({\sep+\w -29}:{\sep+\w +29}:\rr);
     }
