...
\begin{rem}
  ...
  \begin{enumerate}
    \item $\cM_1\otimes\cM_2$ is endowed with the structure of a meromorphic
      ...
      \]
      where $u_i\in\cM_i$ \PROBLEM[how looks the connection matrix?] and
...
\begin{comment}
  \begin{exmp}
    Look at the FALSE example:
    \begin{itemize}
      \item $L=\begin{pmatrix} \alpha & 1 \\ 0 & \alpha \end{pmatrix}$
    ...
    \begin{align*}
      ...
      +
      \begin{pmatrix}
        \frac{\alpha}{t} & \frac{1}{t} \\ 0 & \frac{\alpha}{t}
      \end{pmatrix}
    \end{align*}
  \end{exmp}
\end{comment}
