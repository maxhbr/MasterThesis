...
\begin{defn}
  ...
  We call $F$ a \emph{representation of $\hat F$ on $I\subset S^1$} if
  \begin{itemize}
...
\begin{proof}
  ...
  Lemma.
  A proof can be found in~\cite[Thm.II.2.3.1]{sabbah_cimpa90}.
\end{proof}
