...
Boalch's publications~\cite{boalch,thboalch}.
...
\begin{defn}
  ...
  \begin{s-rem}
    \begin{itemize}
      ...
      \item Some authors introduce multivalued solutions, to avoid the
...
\begin{comment}
  ...
  \begin{proof}
    ...
    where $\cY=t^L e^{Q(t^{-1})}$ is a normal solution.
      ...
      \TODO[Since we are dealing with diagonal matrices it is easy to see
      that\dots]
      % \begin{align*}
      %   \frac{d}{dt}e^{Q(t^{-1})}
