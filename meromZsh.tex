...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{The main asymptotic existence theorem (M.A.E.T)}
\begin{comment}
  \begin{multicols}{2}
    \textbf{Classical:}
    \begin{itemize}
...
\begin{lem}
  ...
  orbit we can use the Proposition~\cite[Prop.3.1]{wielandt1964finite} in the
  book from Wielandt we deduce
  \[
