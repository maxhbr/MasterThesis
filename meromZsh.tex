...
\begin{lem}
  ...
  \begin{enumerate}
    \item 
      ...
      \[
        \mathcal{Y}_0(t)=t^L e^{Q(1/t)}
      \]
      with
      \begin{itemize}
        \item
          $Q(1/t)=\underset{j=1}{\overset{r}{\bigoplus}}\phi_j(t^{-1})1_{r_j}$
          \begin{itemize}
            \item $\sum r_i=n$
            \item i.e.  $Q=\diag(\underset{r_1\text{-times}}{\underbrace{%
              \phi_1,\dots,\phi_1}},\phi_2,\dots,\phi_r)$
          \end{itemize}
          \TODO[ramified case]
