...
\begin{defn}
  ...
  \end{itemize}
\end{defn}
The kernel $\cA^{<0}(I)$ is not zero. Let
$I=\left(-\frac{\pi}{2},\frac{\pi}{2}\right)$, then $\cA^{<0}(I)$ has the
...
\begin{rem}
  ...
  \begin{enumerate}
    \item
      \cite[Thm.4.5.13]{Balser2000Formal}:
      $f_1(t)+f_2(t)$ is asymptotic to $\hat f_1(t)+\hat f_2(t)$.
    \item 
      \cite[Thm.4.5.14]{Balser2000Formal}:
      $f_1(t)f_2(t)$ is asymptotic to $\hat f_1(t)\hat f_2(t)$.
    \item 
      \cite[Thm.4.5.20]{Balser2000Formal}:
      \begin{enumerate}
        \item $f'(t)$ is asymptotic to $\hat f'(t)$.
        \item $\int_0^tf(s)\,ds$ is asymptotic to $\int_0^t\hat f(t)\,ds$.
      \end{enumerate}
    \item 
      \cite[Thm.4.5.21]{Balser2000Formal}:
      $f^{-1}(t)$ is asymptotic to $\hat f^{-1}(t)$.
  \end{enumerate}
