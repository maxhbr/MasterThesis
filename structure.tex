...
Since the factors $\prod_{\alpha\in\A}\SSto_{\alpha}^{k}(A^0)$ are products
...
\begin{einr}
  ...
  \]
  exactly one direction $\alpha\in\A^{k}\cap I$ which satisfies either
  $q_j\underset{\alpha,\max}{\prec}q_l$ or
  $q_l\underset{\alpha,\max}{\prec}q_j$.
\end{einr}
