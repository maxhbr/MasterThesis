ther\chapter{Systems and meromorphic connections}
Here we will start with defining meromorphic connetions on holomorphic bundles
...
The rougth idea to proove this is to use Theorem~\ref{thm:regularConnConstMat}
and assume that the connection matrix $A$ of $(\cR,\nabla)$ is constant.
Since the Gauge transformation by a konstant matrix $F\in\Gl(\C)$ is given by
