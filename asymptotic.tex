...
\begin{rem}
  \begin{itemize}
    \item
      Since the explicit value $r$ of the radius does not matter as long as
      it is small enough, we shall simply speak of an \emph{arc} or
      \emph{interval} $I$ as $\mathfrak{s}_I(r)$ for small enough $r$.
    \item It will be convenient to talk of arcs
      \[
...
\begin{thm}[Borel-Ritt]\label{thm:borel-ritt}
  ...
  \begin{s-rem}
    ...
    sectors but does not garanty uniqueness.}
  \end{s-rem}
\end{thm}
