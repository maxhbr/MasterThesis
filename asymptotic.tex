...
\begin{comment}
  \begin{itemize}
    \item \cite[60]{sabbah_cimpa90} Chapter II.2.2
      \begin{itemize}
        \item \cite{sabbah2000équations}
      \end{itemize}
    \item Van der Put: \cite{van2003galois}: Chapter 7: Exact Asymptotics
    \item \cite[II.5]{sabbah2007isomonodromic}
  \end{itemize}
\end{comment}
\section{Definition}
...
\begin{paracol}{2} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{lem}[\cite{sabbah_cimpa90}: 2.2.5]
  ...
  \switchcolumn{} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{lem}[\cite{sabbah2007isomonodromic}: Borel-Ritt]
    $T$ is onto:
    \[
...
\begin{paracol}{2} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{thm}[\cite{sabbah_cimpa90}: 2.3.1]
    There exists
    \begin{itemize}
  ...
  $\{0\}\times X$.
  \begin{thm}[\cite{sabbah2007isomonodromic}: II.5.12] \label{thm:sectDecomp}
...
\subsection{More from \cite{sabbah_cimpa90}}
