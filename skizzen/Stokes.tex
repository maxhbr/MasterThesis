...
\begin{frame}{Labeling convention (3): Supersectors}
  ...
  \begin{center}
    \begin{tikzpicture}[scale=3]
      ...
      \fill[fill=red!20!white] (0,0) -- ({cos( 15 )*0.2},{sin( 15 )*0.2}) arc
        (15:45:0.2) -- cycle;

      \fill[fill=red!20!white] (0,0) -- ({cos( 55 )*0.2},{sin( 55 )*0.2}) arc
        (55:85:0.2) -- cycle;
  ...
  \begin{center}
    \begin{tikzpicture}[scale=3]
      ...
      \foreach \w/\str in {10/,
                           ...
                           45/,
                           55/}
      {\draw[dotted] (0,0) -- +({cos( \w )},{sin( \w )}) node[right] {\str};
       \fill[blue!20!white] ({cos( \w )},{sin( \w )}) circle (1pt);
       ...
       \foreach \sep in {60,120,180,240,300}
       {\draw[dotted] (0,0) -- +({cos( \w + \sep )},{sin( \w + \sep )});
        \fill[blue!20!white] ({cos( \w + \sep )},{sin( \w + \sep )}) circle (1pt);
       }
      };
