...
\]
and induces a trivialisation:
\[
G\times\mathfrak g\cong TG; \qquad (g,X)\mapsto (g,(dL_g)_1X)
\]
which will be referred to as the \emph{left trivialisation} of $TG$.

By taking the duals the left trivialisation of the cotangent bundle is also
obtained:
\[
...
\TODO
\end{proof}
If the right trivialisations are used instead, the formula looks the same upto
one sign:
\begin{lem}
