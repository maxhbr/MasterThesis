...
\begin{defn}
  Definiere %die \emph{Stokes Garbe}
  \[
    \St(\sM^{good})
...
\begin{defn}
  \marginnote{\tiny Richtungen, entlang denen $e^{q_i-q_j}$ am schnellsten
  fällt}
...
\begin{thm}[3.1]
  ...
  \begin{itemize}
    \item
      ...
      $\Sect_i:=\Sect\left(d_i,d_{i+1}\right)$ einen
      \textcolor{gray}{(kanonischen)} Lift
      \begin{itemize}
